...
namespace BatesMotel.Controllers
{
    ...
    {
        private BatesMotelContext db = new BatesMotelContext();

        private IBookingRepo bookingRepo = null;
        ...
        public ActionResult Create([Bind(Include = "ID,CheckIn_Date,CheckOut_Date,RoomID")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CheckIn_Date,CheckOut_Date,RoomID")] Booking booking)
        {
            if (ModelState.IsValid)
            {
